...
/// HPを増減させるなど、ダメージ処理に関する振る舞いを定義するTrait
pub trait Damagable {
    fn damage(&mut self, amount: u32);
    fn is_destroyed(&self) -> bool;
    fn get_display_hp(&self) -> u32;
}

impl Damagable for Health {
    fn damage(&mut self, amount: u32) {
...
impl Ammo {
    ...
    pub fn consume_primary(&mut self) {
        self.ammo1 = self.ammo1.saturating_sub(1);
    }
    pub fn consume_secondary(&mut self) {
        self.ammo2 = self.ammo2.saturating_sub(1);
    }
}
