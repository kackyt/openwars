...
use crate::ai_standard::islands::{Island, IslandId, IslandMap};
use crate::ai_standard::squad::{MissionPhase, MissionType, SquadManager, TransportPhase};
#[cfg(test)]
use crate::ai_standard::turn_distance::TurnDistanceCache;
...
fn requirement_for_assessment(
    facts: &IslandCampaignFacts,
    assessment: &mut crate::ai_standard::island_campaign::IslandCampaignAssessment,
...
pub fn analyze_island_campaign_excluding(
    ...
    let mut candidates =
        crate::ai_standard::deterministic_parallel::map_ordered(islands, |island| {
    ...
    if uses_operation_driven_production {
        ...
        let mut logistics_registry = world
            .remove_resource::<crate::ai_standard::v4::logistics_plan::V4LogisticsPlanRegistry>()
            .unwrap_or_default();
        crate::ai_standard::v4::logistics_plan::apply_persistent_logistics_plan(
        ...
        if let Some((capital_island, _)) = enemy_capital {
            ...
            let combat_plan_ready = world
                .get_resource::<crate::ai_standard::v4::plan_revision::V4RollingPlanRegistry>()
...
mod tests {
    use super::*;
    use crate::ai_standard::island_campaign::{IslandCampaignDecision, IslandCampaignState};
    use crate::ai_standard::islands::IslandMap;
    use crate::components::{
    ...
    fn repeated_analysis_does_not_mutate_squads_or_shared_distance_cache() {
        ...
        let sentinel = crate::ai_standard::turn_distance::TurnDistance {
            turns: 77,
            used_mp: 88,
        };
