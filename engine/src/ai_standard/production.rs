...
use crate::ai_standard::strategy::{
...
use crate::ai_standard::v4::campaign_execution::{
    CampaignProductionIntent, CampaignProductionRole,
};
...
pub fn decide_production(world: &mut World, player_id: PlayerId) -> Vec<ProduceUnitCommand> {
    ...
    let ai_version = crate::ai_standard::resolve_player_ai_version(world, player_id);
    if ai_version.uses_operation_driven_production() {
        return crate::ai_standard::v4::decide_production_v4(world, player_id);
    }
...
mod additional_tests {
    use super::*;
    use crate::ai_standard::demand::{AirDefenseAssessment, AirThreatTarget};
    use crate::ai_standard::strategy;
    ...
    fn issue75_air_shortage_increases_effective_candidate_score() {
        ...
        covered
            .air_defense
            .apply_coverage(&crate::ai_standard::demand::AirCoverageContribution {
    ...
    fn offshore_test_portfolio(
        target: GridPosition,
    ) -> crate::ai_standard::island_campaign::IslandCampaignPortfolio {
    ...
    fn campaign_production_rejects_zero_capacity_transport() {
        ...
        let rows = vec![
            crate::ai_standard::island_campaign::IslandCampaignShortfall {
                island_id: crate::ai_standard::islands::IslandId(0),
                decision: crate::ai_standard::island_campaign::IslandCampaignDecision::Expand,
    ...
    fn campaign_production_rejects_zero_cost_combat_unit() {
        ...
        let rows = vec![
            crate::ai_standard::island_campaign::IslandCampaignShortfall {
                island_id: crate::ai_standard::islands::IslandId(0),
                decision: crate::ai_standard::island_campaign::IslandCampaignDecision::Defend,
                target_position: GridPosition { x: 0, y: 0 },
    ...
    fn campaign_combat_never_substitutes_a_cheaper_capture_unit() {
        ...
        let rows = vec![
            ...
            crate::ai_standard::island_campaign::IslandCampaignShortfall {
                ...
                decision: crate::ai_standard::island_campaign::IslandCampaignDecision::Assault,
                target_position: GridPosition { x: 0, y: 0 },
                light_transport_slots: 2,
    ...
    fn campaign_production_uses_non_competing_airport_without_spending_secure_reserve() {
        ...
        let rows = vec![
            crate::ai_standard::island_campaign::IslandCampaignShortfall {
                island_id: crate::ai_standard::islands::IslandId(5),
    ...
    fn campaign_combat_requires_an_affordable_non_capture_unit() {
        ...
        let row = |combat_units, reserved_budget| {
            crate::ai_standard::island_campaign::IslandCampaignShortfall {
                island_id: crate::ai_standard::islands::IslandId(0),
                decision: crate::ai_standard::island_campaign::IslandCampaignDecision::Defend,
                target_position: GridPosition { x: 0, y: 0 },
