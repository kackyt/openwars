...
pub fn detect_enemy_clusters(
    ...
    let registry = world
        ...
        .unwrap();
    let mut turn_cache = crate::ai_standard::turn_distance::TurnDistanceCache::default();
        ...
        while let Some((e, pos, stats, enemy_player_id)) = queue.pop() {
            ...
            for j in 0..enemy_units.len() {
                if !visited.contains(&enemy_units[j].0) {
                    ...
                    let turn_dist = crate::ai_standard::turn_distance::calculate_turn_distance(
                        map,
                        registry,
                        &unit_positions,
                        (pos.x, pos.y),
                    ...
                    let turn_dist_rev = crate::ai_standard::turn_distance::calculate_turn_distance(
                        map,
                        registry,
                        &unit_positions,
                        (other_pos.x, other_pos.y),
