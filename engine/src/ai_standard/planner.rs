...
use crate::ai_standard::missions::{TransportMission, TransportMissionManager, TransportPhase};
use crate::ai_standard::objectives::Objective;
...
pub fn is_invasion_allowed(
    world: &mut World,
    player_id: PlayerId,
    _target_island_id: crate::ai_standard::islands::IslandId,
