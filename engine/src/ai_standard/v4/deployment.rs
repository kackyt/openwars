...
use crate::ai_standard::squad::{MissionPhase, MissionType, SquadId, SquadManager};
use crate::ai_standard::turn_distance::TerrainConnectivity;
use crate::ai_standard::v4::operation::SlotKind;
use crate::ai_standard::v4::plan_revision::{ActiveDeploymentIntent, PlanId, PlanStepRef};
...
mod tests {
    ...
    fn closed_plan_releases_assigned_entity_from_mission_protection() {
        use crate::ai_standard::v4::plan_revision::{PlanId, PlanRevision, PlanStepId};
