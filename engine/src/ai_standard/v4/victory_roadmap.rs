use crate::ai_standard::engine::AiCommand;
use crate::ai_standard::island_campaign::{
    IslandCampaignAssignment, IslandCampaignDecision, IslandCampaignPortfolio,
};
use crate::ai_standard::islands::{IslandId, IslandMap};
use crate::ai_standard::squad::{MissionPhase, MissionType, SquadManager, TransportPhase};
use crate::ai_standard::turn_distance::{TurnDistanceCache, calculate_turn_distance};
use crate::ai_standard::v4::deployment::V4DeploymentRegistry;
use crate::ai_standard::v4::plan_revision::{
    ActiveCombatPlanSummary, PlanId, V4RollingPlanRegistry,
};
...
fn diagnose_operation_execution(
    ...
    production_records: &[crate::ai_standard::v4::campaign_execution::CampaignProductionRecord],
) -> Vec<OperationIssue> {
    use crate::ai_standard::v4::campaign_execution::{
        CampaignProductionRole, CampaignProductionStatus,
    };
...
pub(crate) fn reconcile_campaign_roadmap(
    ...
    if let Some(mut execution) =
        world.get_resource_mut::<crate::ai_standard::v4::campaign_execution::V4CampaignExecutionRegistry>()
    {
...
pub fn audit_victory_roadmap_system(
    ...
    campaign_execution: Option<
        ResMut<crate::ai_standard::v4::campaign_execution::V4CampaignExecutionRegistry>,
    >,
    operation_assignments: Option<
        ResMut<crate::ai_standard::operation_assignment::UnitOperationRegistry>,
    >,
) {
...
mod tests {
    ...
    fn issue_detection_is_not_counted_as_replanning_until_recovery_occurs() {
        ...
        let island_map = IslandMap {
            islands: vec![
                crate::ai_standard::islands::Island {
                    id: IslandId(1),
                    tiles: HashSet::from([
