use crate::ai_standard::eval::evaluate_board;
use crate::ai_standard::simulation::AiSimulationState;
use crate::ai_standard::squad::{MissionType, Squad, SquadManager};
...
pub struct SquadAssignmentPlan {
    /// キー: Squad ID
    /// 値: 割り当てられた目標座標
    pub assignments: HashMap<crate::ai_standard::squad::SquadId, GridPosition>,
    /// プランの暫定評価スコア
    pub score: i32,
}
...
pub fn run_squad_beam_search(world: &mut World, perspective_player: PlayerId) {
    ...
    let enemy_clusters =
        crate::ai_standard::cluster::detect_enemy_clusters(world, perspective_player);
    ...
    // 3. ビーム探索の開始
    let mut search_cache = crate::ai_standard::turn_distance::AiTurnCache::new();
    ...
    for squad in &active_squads {
        ...
        if squad.mission_type != MissionType::Transport
            ...
            && let Some(island_map) = world.get_resource::<crate::ai_standard::islands::IslandMap>()
        {
...
mod tests {
    ...
    fn setup_test_world() -> World {
        ...
        world.insert_resource(crate::ai_standard::ai_version::PlayerAiSettings::default());
        world
    }
    ...
    fn test_beam_search_assigns_targets() {
        ...
        let mut squad = Squad {
            ...
            target: None,
            target_island: None,
            phase: crate::ai_standard::squad::MissionPhase::Forming,
        ...
        settings.set_version(p1, crate::ai_standard::ai_version::AiVersion::V2);
        ...
        assert_eq!(
            ...
            crate::ai_standard::squad::MissionPhase::MovingToTarget
        );
    }
    ...
    fn beam_search_preserves_foreign_owned_squad() {
        ...
        foreign.phase = crate::ai_standard::squad::MissionPhase::Executing;
        ...
        assert_eq!(
            foreign.phase,
            crate::ai_standard::squad::MissionPhase::Executing
        );
    ...
    fn beam_search_preserves_campaign_managed_local_target_and_phase() {
        ...
        squad.phase = crate::ai_standard::squad::MissionPhase::Executing;
