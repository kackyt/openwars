...
use crate::ai_standard::squad::{MissionType, Squad};
use crate::ai_standard::turn_distance::calculate_all_turn_distances_cached;
...
impl AiSimulationState {
    ...
    pub fn simulate_plan(
        world: &mut World,
        squads: &[Squad],
        assignments: &HashMap<crate::ai_standard::squad::SquadId, GridPosition>, // Squad ID -> Target GridPosition
        perspective_player: PlayerId,
        cache: &mut crate::ai_standard::turn_distance::AiTurnCache,
    ) {
            ...
            for &member in &squad.members {
                ...
                // pos のスコープを限定して借用チェッカーを回避する
                {
                    ...
                    let interaction_max_range = match squad.mission_type {
                        ...
                        | crate::ai_standard::squad::MissionType::Defense => {
                        ...
                        crate::ai_standard::squad::MissionType::Capture => 0,
                        crate::ai_standard::squad::MissionType::Transport
                        | crate::ai_standard::squad::MissionType::Reserve => 1,
                    };
                    ...
                    let current_turns = *dist_map.get(&pos).unwrap_or(
...
mod tests {
    use super::*;
    use crate::ai_standard::squad::{MissionPhase, MissionType, SquadId};
    ...
    fn test_simulate_plan_moves_units() {
        ...
        let mut cache = crate::ai_standard::turn_distance::AiTurnCache::new();
