...
#[cfg(test)]
use crate::ai_standard::ai_version::PlayerAiSettings;
use crate::ai_standard::ai_version::{AiVersion, resolve_player_ai_version};
...
fn capture_eta(
    ...
    turn_cache: &mut crate::ai_standard::turn_distance::AiTurnCache,
) -> Option<u32> {
    // 徒歩 ETA
    let inf_map = crate::ai_standard::turn_distance::calculate_all_turn_distances_cached(
        map,
        registry,
        unit_positions,
        prop_pos,
    ...
    for t in transports {
        ...
        let carry_map = crate::ai_standard::turn_distance::calculate_all_turn_distances_cached(
            map,
            registry,
            unit_positions,
            prop_pos,
...
pub fn evaluate_board(
    ...
    cache: Option<&mut crate::ai_standard::turn_distance::AiTurnCache>,
) -> i32 {
...
pub fn evaluate_board_with_metrics(
    ...
    match ai_version {
        AiVersion::V1 | AiVersion::V100 => evaluate_board_v1(world, perspective_player),
        // V3/V4 は V2 の評価をベースに、#49 の回復インフラ評価項を追加する
        AiVersion::V2 | AiVersion::V3 | AiVersion::V4 | AiVersion::V200 => evaluate_board_v2(
            world,
            perspective_player,
            cache,
...
fn side_front_pressure(
    ...
    island_map: Option<&crate::ai_standard::islands::IslandMap>,
) -> i32 {
    let mut total = 0i32;
...
fn evaluate_board_v2(
    ...
    let mut local_cache = crate::ai_standard::turn_distance::AiTurnCache::default();
...
pub fn compute_objective_metrics(world: &mut World, player: PlayerId) -> ObjectiveMetrics {
    ...
    // NPV (獲得機会価値)
    let mut cache = crate::ai_standard::turn_distance::AiTurnCache::default();
...
mod tests {
    ...
    fn test_capture_eta_transport_advantage() {
        ...
        let mut cache2 = crate::ai_standard::turn_distance::AiTurnCache::default();
